...
export default function Form16() {
  ...
  return (
    <>
      <div className="flex justify-center items-center h-screen w-screen bg-gradient-to-tl from-yellow-300 via-orange-400 to-rose-600">
        <div className="flex justify-center items-center m-2 p-2 bg-gradient-to-br from-yellow-300 via-orange-400 to-red-600 rounded">
          <div className="px-10 py-5 w-[330px] bg-white rounded">
